...
export default function AboutDeveloper() {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#0B0F17] font-['Inter',sans-serif] text-white overflow-y-auto overflow-x-hidden flex justify-center">
      
      {/* Centered Mobile Wrapper */}
      <div className="w-full max-w-md relative min-h-screen">
        
        {/* Fixed Hero Image Background */}
        <div className="fixed top-0 w-full max-w-md h-[60vh] z-0 overflow-hidden">
          <img 
            src="/photo.jpg" 
            alt="Aayush Sharma" 
